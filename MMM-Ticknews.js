...
Module.register('MMM-Ticknews', {
    ...
    notificationReceived: function(notification, payload) {
        if (notification === 'HIDE_ARTICLE') {
          console.log("CLOSING IFRAME");
        } else if (notification === 'SHOW_ARTICLE') {
          console.log("I hear you.....MMM-Ticknews");
        }
        return notification;
    },
    ...
    getDom: function() {
        ...
        if (keys.length > 0) {
            ...
            console.log(this.notificationReceived());
            //if (notificaton == "SHOW_ARTICLE") {
            //title.addEventListener("click", () => showdesc(this));
            //} else {
            ...
            function showdesc(thisdesc) {
              var self = this;
                thisdesc.intpause();
              //  var readTimer = setTimeout(function() {hidedesc(thisdesc)},
